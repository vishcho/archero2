...
| round4（7/31） | ⚠️ 遺失 | ⚠️ 遺失 | ⚠️ 64張/59人 | ✅ 65 | matchup/rank 原為 Telegram `photo_*.jpg`，未落到 `screenshots/` 而遺失；資料已完整抽取進 `data/star-cup/2026-07-31.json`。top64 有 5 位重複拍攝，涵蓋 59/64 位 |
| round5（8/14） | — | — | — | — | 未開始 |
...
| `screenshots/star-cup/2026-08-09-round4-top64/` | 2026-08-09 | 64（涵蓋 **59 位**） | 8/9 明星盃資格賽前 64 名的個人資訊名片（用戶ID、公會、普通/困難關卡、通天塔、戰力、魅力值、徽記、稱號）；本專案**首批 `top64`**。5 位被重複點開（龍×이뮤、Yööᶠˣ、coco幻、橙色楓葉、秘運行者Kai），故未涵蓋資格賽第 48、57、60、64 名 | `data/players.json`（新建，59 位跨賽事選手登記簿）、回填 `data/star-cup/2026-07-31.json`（兩位「牛大力」以用戶ID 區分，`⚠` 已移除並補齊資格賽名次）。確認改名 `o月亮惹的禍o`→`送你離開`。見 [top64-profile-workflow.md](../notes/workflows/top64-profile-workflow.md) |
