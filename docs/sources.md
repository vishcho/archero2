...
| round4（7/31） | ⚠️ 遺失 | ⚠️ 遺失 | ⚠️ 68張/63人 | ✅ 65 | matchup/rank 原為 Telegram `photo_*.jpg`，未落到 `screenshots/` 而遺失；資料已完整抽取進 `data/star-cup/2026-07-31.json`。top64 初拍 5 位重複、補拍 4 張後涵蓋 63/64 位 |
| round5（8/14） | — | — | — | — | 未開始 |
...
| `screenshots/star-cup/2026-07-31-round4-matchup/` ⚠️ **圖已遺失** | 2026-07-31 | 8 | 7/31 明星盃淘汰賽賽前對陣（10-21-55＝第1組，10-21-57–10-22-11＝第2–8組）。原檔為 Telegram 轉存的 `photo_*.jpg`，未落到 `screenshots/`，目錄現已不存在 | [2026-07-31-round4-matchup.md](./star-cup/2026-07-31-round4-matchup.md)、[2026-07-31-round4-betting-guide.md](./star-cup/2026-07-31-round4-betting-guide.md)、`tmp/2026-07-31-round4-matchup.json`（groups 已於 2026-08-06 連同結果併入 `data/2026-07-31.json`）。資料完整，僅損失重驗能力 |
...
| `screenshots/star-cup/2026-08-09-round4-top64/` | 2026-08-09 | 68（涵蓋 **63 位**） | 8/9 明星盃資格賽前 64 名的個人資訊名片（用戶ID、公會、普通/困難關卡、通天塔、戰力、魅力值、徽記、稱號）；本專案**首批 `top64`**。01:10–01:24 拍 64 張但 5 位被重複點開（龍×이뮤、Yööᶠˣ、coco幻、橙色楓葉、秘運行者Kai）；**02:17 補拍 4 張**（資格賽第 48、57、60、64 名）。合計 68 張涵蓋 63 位，仍缺第 46 名「龍×똥꼬」 | `data/players.json`（新建，63 位跨賽事選手登記簿）、回填 `data/star-cup/2026-07-31.json`（**62/64 位掛上 `player_id`**；兩位「牛大力」以用戶ID 區分，`⚠` 已移除並補齊資格賽名次）。確認改名 `o月亮惹的禍o`→`送你離開`；確認第 64 名「牛大办」實為**牛大刃**（`101821232`）。見 [top64-profile-workflow.md](../notes/workflows/top64-profile-workflow.md) |
