...
| round4（7/31） | ⚠️ 遺失 | ⚠️ 遺失 | ✅ 64 | ✅ 65 | matchup/rank 原為 Telegram `photo_*.jpg`，未落到 `screenshots/` 而遺失；資料已完整抽取進 `data/star-cup/2026-07-31.json` |
| round5（8/14） | — | — | — | — | 未開始 |
...
| `screenshots/star-cup/2026-08-09-round4-top64/` | 2026-08-09 | 64 | 8/9 明星盃資格賽前 64 名的個人資訊名片（用戶ID、公會、普通/困難關卡、通天塔、戰力、魅力值、徽記、稱號）；本專案**首批 `top64`** | ⏳ 尚未分析——待建 `data/star-cup/players.json` 選手檔案庫，見 [top64-profile-workflow.md](../notes/workflows/top64-profile-workflow.md) |
